    ...
    <div className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 max-md:absolute max-md:h-screen ${expand ? "p-4 w-64" : "md:w-20 w-0 max-md:overflow-hidden"}`}>
        <div>
            ...
            <button className={`mt-8 flex items-center justify-center cursor-pointer ${expand ?
                ...
                "group relative h-9 w-9 mx-auto hover:bg-gary-500/30 rounded-lg"}`}>
                <Image className={expand ? 'w-6' : 'w-7'} src={expand ? assets.chat_icon : assets.chat_icon_dull} alt=''/>
                <div className='absolute w-max -top-12 -rigth-12 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3
